...
function VerifyEmailContent() {
  ...
  const defaultMethod = email ? "email" : "mobile";
  ...
  return (
    <AuthShell title="Verify OTP" subtitle={`Enter the OTP sent to ${selectedMethod === "email" ? email || "your email address" : mobile || "your mobile number"}.`}>
